...
import com.afq.zefaf.Fragments.ItemFragment.OnListFragmentInteractionListener;
...
public class MyFragmentItemRecyclerViewAdapter extends RecyclerView.Adapter<MyFragmentItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyFragmentItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
